...
public:
    ...
    Parameters() :
        ...
        pi_stabilize_roll       (0.110f,      1,       350),
        pi_stabilize_pitch      (0.157f,     1,      350),
        pi_stabilize_yaw        (0.073f,       1,        350),

        pi_stabilize_roll_tilt       (0.192f,      1,       350),
        pi_stabilize_pitch_tilt      (1.600f,     1,      350),
        pi_stabilize_yaw_tilt        (0.042f,       1,        350),
