...
public:
  ...
  pid_rate_roll_tilt           (0.6f,           0,            0,            0), // Tested new D param for roll.
  pid_rate_pitch_tilt          (13.794f,          0,           0,           0),
  ...
  pi_stabilize_roll_tilt       (2.42f,      1,       350),
  pi_stabilize_pitch_tilt      (7.4f,     1,      500),
  pi_stabilize_yaw_tilt        (0.47f,       1,        350),
