...
public:
  ...
  pid_rate_roll_tilt           (0.17f,           0,            0,            0), // Tested new D param for roll.
  pid_rate_pitch_tilt          (0.375f,          0,           0,           0),
  ...
  pi_stabilize_roll_tilt       (1.0f,      1,       350),
  pi_stabilize_pitch_tilt      (2.0f,     1,      500),
